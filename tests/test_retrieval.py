...
class TestQueryEngine:
    ...
    def test_llamaindex_setup_ollama(self, mock_embedding, mock_ollama, mock_settings, mock_storage):
    ...
    def test_llamaindex_setup_openai(self, mock_embedding, mock_openai, mock_settings, mock_storage):
    ...
    def test_keyword_search(self):
        ...
        with patch("askyourdocs.core.retrieval.VectorStoreManager") as mock_storage:
            with patch("askyourdocs.core.retrieval.Settings"):
                ...
                with patch("askyourdocs.core.retrieval.VectorIndexRetriever") as mock_retriever:
                    mock_node = Mock()
